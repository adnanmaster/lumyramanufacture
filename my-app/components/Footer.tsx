    ...
    <footer className="bg-[#f5f3ee] dark:bg-[#121210] w-full pt-20 pb-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 max-w-screen-2xl mx-auto">
        <div className="col-span-1 md:col-span-1">
          <h3 className="font-serif text-xl text-[#565f4c] mb-6">
            Lumyra Manufacture
          </h3>
          <p className="font-sans text-sm tracking-wide text-[#1b1c19] dark:text-[#fbf9f4] opacity-80 leading-relaxed">
            Celebrating the intersection of heritage craft and modern
            minimalism. Crafted for slow living.
          </p>
        </div>
        <div>
          <h4 className="font-sans text-xs font-bold uppercase tracking-[0.2em] mb-6 text-on-surface-variant">
            Shop
          </h4>
        ...
        <div>
          ...
          <ul className="space-y-3 font-sans text-sm tracking-wide text-[#1b1c19] dark:text-[#fbf9f4]">
            <li>
              <a
                className="opacity-80 hover:opacity-100 transition-opacity"
                href="https://www.instagram.com/lumyra.manufacture/"
                target="blank"
              >
                Instagram
              </a>
